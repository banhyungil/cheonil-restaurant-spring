...
public interface OrderMenuRepo extends JpaRepository<OrderMenu, OrderMenuId> {
     ...
     * <p>
     * t_order_menu 와 m_menu 사이에 JPA 연관관계가 선언돼 있지 않아 ad-hoc {@code join ... on} 사용
     * (Hibernate 5.1+ 지원). 결과를 {@link OrderMenuExtRes} record 의 canonical constructor 로
     * 직접 변환 (constructor expression).
     */
    @Query("""
