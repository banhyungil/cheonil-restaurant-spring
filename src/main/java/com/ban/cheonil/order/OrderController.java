 ...
 * HTTP 요청 (JSON)
 *     ↓
 * Spring MVC: @RestController + @RequestBody 인식
 *     ↓
 * HttpMessageConverter (기본: MappingJackson2HttpMessageConverter)
 *     ↓
 * Jackson ObjectMapper.readValue(json, OrderCreateReq.class)
 *     ↓
...
public class OrderController {
    ...
    /**
     * 주문 목록 — 매장/메뉴 join aggregate.
     * Query params: statuses, cookedSince, storeSeq, orderFrom, orderTo (모두 optional).
     * 배열 statuses 는 콤마 join 형식 (?statuses=READY,COOKED) 으로 받음.
     */
    @GetMapping
