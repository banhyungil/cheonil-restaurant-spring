...
class OrderRsvTmplRepoTest {
  ...
  void matchesAllConditions() {
    save(makeTmpl((short) 1, true, LocalTime.of(12, 30), new String[] {"MON", "WED"},
    ...
    var result =
        repo.findActiveInWindow(date, "MON", LocalTime.of(12, 30), LocalTime.of(12, 40));
  ...
  void excludeInactive() {
    save(makeTmpl((short) 2, false, LocalTime.of(12, 30), new String[] {"MON"},
        LocalDate.of(2026, 1, 1), null));
    em.flush();
    em.clear();

    var result = repo.findActiveInWindow(
  ...
  void excludeWrongDay() {
    save(makeTmpl((short) 3, true, LocalTime.of(12, 30), new String[] {"TUE"},
        LocalDate.of(2026, 1, 1), null));
    em.flush();
    em.clear();
  ...
  void excludeOutOfWindow() {
    save(makeTmpl((short) 4, true, LocalTime.of(11, 0), new String[] {"MON"},
        LocalDate.of(2026, 1, 1), null));
    em.flush();
    em.clear();
  ...
  void excludeEnded() {
    save(makeTmpl((short) 5, true, LocalTime.of(12, 30), new String[] {"MON"},
        LocalDate.of(2026, 1, 1), LocalDate.of(2026, 4, 1))); // end_dt 4/1
    em.flush();
    em.clear();
  ...
  void includeOpenEnded() {
    save(makeTmpl((short) 6, true, LocalTime.of(12, 30), new String[] {"MON"},
        LocalDate.of(2026, 1, 1), null));
    em.flush();
    em.clear();
  ...
  void excludeNotStarted() {
    save(makeTmpl((short) 7, true, LocalTime.of(12, 30), new String[] {"MON"},
        LocalDate.of(2026, 5, 1), null)); // start_dt 5/1
    em.flush();
    em.clear();
  ...
  void mixed() {
    save(makeTmpl((short) 1, true, LocalTime.of(12, 30), new String[] {"MON"},
        LocalDate.of(2026, 1, 1), null)); // 매칭
    save(makeTmpl((short) 2, false, LocalTime.of(12, 30), new String[] {"MON"},
        LocalDate.of(2026, 1, 1), null)); // skip
    save(makeTmpl((short) 3, true, LocalTime.of(13, 0), new String[] {"MON"},
        LocalDate.of(2026, 1, 1), null)); // skip (시간 밖)
    save(makeTmpl((short) 4, true, LocalTime.of(12, 35), new String[] {"MON", "WED"},
        LocalDate.of(2026, 1, 1), null)); // 매칭
    em.flush();
    em.clear();
